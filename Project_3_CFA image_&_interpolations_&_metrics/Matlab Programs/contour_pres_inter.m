...
function out = contour_pres_inter(im_CFA_uint8, selecteur)
...
green_band = green_gen(im_cfa, selecteur); %selecteur = 2 : choisir le case 2 du switch de green_ge() qui corespond a l'algo 
%%
for i=2:H-1
   for j=2:W-1
%%%%%%%%%%%% pair:
