...
face_original = imread('school.jpg');
...
figure, imshow(face_original), title('Detection Result'), xlabel (['#faces found: ', num2str(length(face_idx))])
hold on
